      ...
      <div
          ...
          <Accordion type="single" collapsible className="w-full text-black">
              <AccordionItem value="item-1">
                  <AccordionTrigger className='p-3 rounded-2xl bg-white mt-8 font-semibold'>Who is Stubby?</AccordionTrigger>
                  <AccordionContent style={{ backgroundColor: 'rgb(255, 255, 255, .6)', borderRadius: '24px', marginTop: '1rem', padding: '1rem'}}>
