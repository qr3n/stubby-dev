...
const Tasks: FC = () => {
  return (
      <div
          ...
          <div className='p-4 bg-white w-full rounded-2xl mt-6 text-[#303131] flex gap-3 items-center font-semibold'>
              <img src={bell} alt='' className='w-8'/>
              Subscribe
          </div>
          <div className='p-4 bg-white w-full rounded-2xl mt-3 text-[#303131] flex gap-3 items-center font-semibold'>
